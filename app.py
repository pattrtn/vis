...
if st.button("Run"):
    ...
    print(subdistrict, district, province, postal_code)

    print(geo_data['subdistrict'] == subdistrict)
    print(geo_data['district'] == district)
    print(geo_data['province'] == province)
    print(geo_data['zipcode'] == postal_code)
